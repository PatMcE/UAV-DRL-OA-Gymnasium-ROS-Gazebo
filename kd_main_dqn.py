...
from kd_dqn_agent import DQNAgentLearner
...
if __name__ == '__main__':
    ...
    parser.add_argument('-eps_start', type=float, default=1.0, help='What epsilon starts at')    
    parser.add_argument('-eps_min', type=float, default=0.05, help='Minimum value for epsilon in epsilon-greedy action selection')
    parser.add_argument('-exploration_steps', type=float, default=60000, help='Number of steps before epsilon levels out at eps_min')#120000
    ...
    figure_file = args.root_path + 'plots/DQN_KD.png' 
    save_load_dir = args.root_path + 'models/'   
    tb_log_dir = args.root_path + 'tb_logs/DQN'
    ...
    agent = DQNAgentLearner(n_actions=env.action_space.n,
